...
[![codebeat badge](https://codebeat.co/badges/18a37f35-6a95-4e40-9e78-272233892332)](https://codebeat.co/projects/github-com-matchiapp-gocloak-main)
[![Go Report Card](https://goreportcard.com/badge/github.com/matchiapp/gocloak)](https://goreportcard.com/report/github.com/matchiapp/gocloak)
[![Go Doc](https://godoc.org/github.com/matchiapp/gocloak?status.svg)](https://godoc.org/github.com/matchiapp/gocloak)
[![Build Status](https://github.com/matchiapp/gocloak/workflows/Tests/badge.svg)](https://github.com/matchiapp/gocloak/actions?query=branch%3Amain+event%3Apush)
[![GitHub release](https://img.shields.io/github/tag/matchiapp/gocloak.svg)](https://GitHub.com/matchiapp/gocloak/releases/)
[![codecov](https://codecov.io/gh/matchiapp/gocloak/branch/master/graph/badge.svg)](https://codecov.io/gh/matchiapp/gocloak)
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fmatchiapp%2Fgocloak.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2Fmatchiapp%2Fgocloak?ref=badge_shield)
...
If u are using the echo framework have a look at [gocloak-echo](https://github.com/matchiapp/gocloak-echo)

Benchmarks can be found [here](https://matchiapp.github.io/gocloak/dev/bench/)

## Contribution

(WIP) <https://github.com/matchiapp/gocloak/wiki/Contribute>

## Changelog

For release notes please consult the specific releases [here](https://github.com/matchiapp/gocloak/releases)
...
```shell
go get github.com/matchiapp/gocloak/v11
```

### Importing

```go
 import "github.com/matchiapp/gocloak/v11"
```
...
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fmatchiapp%2Fgocloak.svg?type=large)](https://app.fossa.io/projects/git%2Bgithub.com%2Fmatchiapp%2Fgocloak?ref=badge_large)
